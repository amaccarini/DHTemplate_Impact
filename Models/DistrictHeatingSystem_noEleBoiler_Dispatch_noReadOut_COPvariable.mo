...
model DistrictHeatingSystem_noEleBoiler_Dispatch_noReadOut_COPvariable "System model"
  ...
  .Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(
    ...
    .Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam = Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos")) annotation(Placement(transformation(extent = {{-138,80},{-118,100}},origin = {0,0},rotation = 0)));
    .Buildings.BoundaryConditions.WeatherData.Bus weaBus annotation(Placement(transformation(extent = {{-102,80},{-82,100}},origin = {0,0},rotation = 0)));
protected
  // Junctions
...
equation
  ...
  connect(jun5.port_2, heatPump.port_a) annotation (Line(points={{-54,-50},{
    ...
    connect(weaDat.weaBus,weaBus) annotation(Line(points = {{-118,90},{-92,90}},color = {255,204,51}));
    connect(heatPump.T_source_in,weaBus.TDryBul) annotation(Line(points = {{-88,0},{-82,0},{-82,90},{-92,90}},color = {0,0,127}));
  annotation (
...
end DistrictHeatingSystem_noEleBoiler_Dispatch_noReadOut_COPvariable;
